...
public class ClawAttack : MonoBehaviour
{
    ...
    {
        GameObject ClawsEff = Instantiate(clawsEffect, transform.position, transform.rotation);
        ClawsEff.transform.Rotate(0,0,100);
        Destroy(ClawsEff,0.25f);
